  ...
  const images2 = [
    {
      id: 10782,
      url:
        '//images.treebohotels.com/files/./Treebo_Akshaya_Lalbagh_Inn/Akshaya_Lalbagh_Oak_Queen_03.jpg',
      is_showcased: true,
    ...
    },
    {
      id: 4670,
      url:
        '//images.treebohotels.com/files/./Treebo_Akshaya_Lalbagh_Inn/1Treebo_Akshaya_Lalbagh_Main.jpg',
      is_showcased: false,
      tagline: 'Treebo Akshaya Lalbagh Inn',
    ...
    },
    {
      id: 4682,
      url:
        '//images.treebohotels.com/files/./Treebo_Akshaya_Lalbagh_Inn/Maple/4Treebo_Akshaya_Lalbagh_Maple.jpg',
      is_showcased: false,
      tagline: 'Treebo Akshaya Lalbagh Inn',
    ...
    },
    {
      id: 4679,
      url:
        '//images.treebohotels.com/files/./Treebo_Akshaya_Lalbagh_Inn/Oak/2Treebo_Akshaya_Lalbagh_Oak.jpg',
      is_showcased: false,
      tagline: 'Treebo Akshaya Lalbagh Inn',
    ...
    },
    {
      id: 4683,
      url:
        '//images.treebohotels.com/files/./Treebo_Akshaya_Lalbagh_Inn/Maple/Treebo_Akshaya_Lalbagh_Maple_Room.jpg',
      is_showcased: false,
      tagline: 'Treebo Akshaya Lalbagh Inn',
    ...
    },
    {
      id: 4676,
      url:
        '//images.treebohotels.com/files/./Treebo_Akshaya_Lalbagh_Inn/Oak/Treebo_Akshaya_Lalbagh_Oak_room.jpg',
      is_showcased: false,
      tagline: 'Treebo Akshaya Lalbagh Inn',
    ...
    },
    {
      id: 4681,
      url:
        '//images.treebohotels.com/files/./Treebo_Akshaya_Lalbagh_Inn/Maple/Treebo_Akshaya_Lalbagh_Maple_Room2.jpg',
      is_showcased: false,
      tagline: 'Treebo Akshaya Lalbagh Inn',
    ...
    },
    {
      id: 4680,
      url:
        '//images.treebohotels.com/files/./Treebo_Akshaya_Lalbagh_Inn/Maple/5Treebo_Akshaya_Lalbagh_Maple_Bathroom.jpg',
      is_showcased: false,
      tagline: 'Treebo Akshaya Lalbagh Inn',
    ...
    },
    {
      id: 4678,
      url:
        '//images.treebohotels.com/files/./Treebo_Akshaya_Lalbagh_Inn/Oak/Treebo_Akshaya_Lalbagh_Oak_room3.jpg',
      is_showcased: false,
      tagline: 'Treebo Akshaya Lalbagh Inn',
    ...
    },
    {
      id: 4677,
      url:
        '//images.treebohotels.com/files/./Treebo_Akshaya_Lalbagh_Inn/Oak/3Treebo_Akshaya_Lalbagh_Oak_Bathroom.jpg',
      is_showcased: false,
      tagline: 'Treebo Akshaya Lalbagh Inn',
  ...
  const images3 = [
    {
      id: 10781,
      url:
        '//images.treebohotels.com/files/./Treebo_Akshaya_Mayflower/Akshaya_Mayflower_Mahogany_(8).jpg',
      is_showcased: true,
    ...
    <div>
      <Spacer margin={[5]}>
        <Gallery isAvailable>
          {
            images1.map((image) => (
              <span key={image.url} style={{ background: '#AEAEAE', display: 'inline-flex' }}>
      ...
      <Spacer margin={[5]}>
        <Gallery id="gallery2" isAvailable>
          {
            images2.map((image) => (
              <span key={image.url} style={{ background: '#AEAEAE', display: 'inline-flex' }}>
                <Image alt="img-2" height="300px" width="300px" src={image.url} />
              </span>
          ))
          }
        </Gallery>
      ...
      <Spacer margin={[5]}>
        <Gallery isAvailable id="gallery3">
          {
            images3.map((image) => (
              <span key={image.url} style={{ background: '#AEAEAE', display: 'inline-flex' }}>
                <Image alt="img-3" height="300px" width="300px" src={image.url} />
              </span>
          ))
          }
        </Gallery>
      ...
      <Spacer margin={[5]}>
        <Gallery isAvailable id="gallery4">
          {
            images4.map((image) => (
              <span key={image.url} style={{ background: '#AEAEAE', display: 'inline-flex' }}>
                <Image alt="img-4" height="300px" width="300px" src={image.url} />
              </span>
          ))
          }
        </Gallery>
